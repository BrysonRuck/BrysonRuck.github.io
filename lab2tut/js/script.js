...
function initializeGame() {
    document.querySelector("#tries").textContent = 7;
    document.querySelector("#winLoose").textContent = "wins: " + win + " losses:" + lose;
  ...
  function checkGuess() {
    ...
    document.querySelector("#tries").textContent = 7 - attempts;
